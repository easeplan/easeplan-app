...
Save to grepper
In the code snippet above, when the phone number is hidden, we display the entered phone number as plain text followed by the "Change number" option. Clicking on this button will show the phone number input again.

This flow ensures that:

Users can change their phone number if they made an error.
The user experience is intuitive and aligns with industry standards.
The verification process remains secure by preventing changes after successful verification (you might want to clear the token field and hide the number again if the verification fails).
