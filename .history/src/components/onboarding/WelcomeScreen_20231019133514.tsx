            ...
            >
              ...
              <Typography variant="body2" style={{ marginBottom: 20 }}>
                ...
                <List>
                  ...
                  <ListItem>
                        <ListItemText
                          primary={`6. Liability and Indemnity `}
                        />
                      </ListItem>
                      <ListItem button style={{ paddingLeft: 32 }}>
                      ...
                      <ListItem button style={{ paddingLeft: 32 }}>
                        <ListItemText primary="6.3. You undertake to indemnify Us within 14 days of Your notice against:" />
                      </ListItem>
                  </List>
                    </Collapse>
                </List>
