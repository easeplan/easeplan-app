import { Box, Divider, Typography, Button, Modal,  Collapse, } from '@mui/material';
          ...
          <List>
            ...
            <List component="div" disablePadding>
              <ListItem button style={{ paddingLeft: 32 }}>
                <ListItemText primary="1.1 'Easeplan' is the trading name for Easeplan Limited, ..." />
              </ListItem>
              <ListItem button style={{ paddingLeft: 32 }}>
                <ListItemText primary="1.2 This document, referred to as “Vendors’ Undertaking”..." />
              </ListItem>
            </List>
