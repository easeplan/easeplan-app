...
const ProfileSettings = ({ token }: PropsTypes) => {
  ...
  const FormSchema = Yup.object().shape({
        firstName: Yup.string().required(`CAC number is required`),
        lastName:Yup.string().required(`CAC number is required`),
        picture:Yup.string().required(`CAC number is required`),
        gender: Yup.string().required(`CAC number is required`),
        image: Yup.string().required(`CAC number is required`),
        state: Yup.string().required(`CAC number is required`),
        city: Yup.string().required(`CAC number is required`),
  });
