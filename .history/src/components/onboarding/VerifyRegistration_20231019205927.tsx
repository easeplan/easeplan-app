...
import { setIntroTwo, setIntroOne, setIntroThree } from '@/features/onboardingSlice';
...
const AddPricingSection = ({ token }: PropsTypes) => {
  ...
  const { stepOne,stepTwo } = useSelector((state: RootState) => state.onboarding);
