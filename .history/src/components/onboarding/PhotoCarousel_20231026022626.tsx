...
const InstagramOnboarding: React.FC = () => {
  ...
  const loadPhotos = async () => {
    const data = await fetchInstagramPhotos(`IGQWRPZA1dBV095bTQ1R2dNZAmtRSUsxalhkREpKQ1U4em4taEVDSXBuN19GT09HM3ZAsTDJHaFF4enJoWjQxSG4tQ0lQeDJ3SHN0NzdDODMtTnduNUxmbjlHS09LU3dSZAUtoV0xvdnA3Y2V0RjBvbXZAHS2F5OW9OZAXdnbVZAJYXJCUklzOHMZD`, `USER_ID`);
    setPhotos(data);
  };
