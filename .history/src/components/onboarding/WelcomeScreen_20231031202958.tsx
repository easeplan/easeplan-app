...
import { setIntro, setIntroOne, setIntroTwo, setIntroThree, setIntroFour, setIntroFive,setIntroSix } from '@/features/onboardingSlice';
...
const WelcomeScreen = ({token}: PropsTypes) => {
  ...
  const handleConitueOnboarding =()=>{
     if(queryData.provider.onboardStage ==0){
      ...
      dispatch(setIntroTwo(false));
      dispatch(setIntroThree(false));
      dispatch(setIntroFour(false));}else if(queryData.provider.onboardStage ==1){
  dispatch(setIntro(false));
  dispatch(setIntroOne(true));
  dispatch(setIntroTwo(false));
  dispatch(setIntroThree(false));
  ...
  dispatch(setIntroSix(false));
      ...
      dispatch(setIntroFive(false));}else if(queryData.provider.onboardStage ==1){
  dispatch(setIntro(false));
  dispatch(setIntroOne(true));
  dispatch(setIntroTwo(false));
  dispatch(setIntroThree(false));
