...
import { Card, CardMedia, CardContent, Checkbox, Typography, MobileStepper, Button } from "@material-ui/core";
...
const PhotoCarousel: React.FC<PhotoCarouselProps> = ({ photos, selectedPhotos, onSelectPhoto }) => {
