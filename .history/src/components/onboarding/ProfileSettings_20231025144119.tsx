...
const ProfileSettings = ({ token }: PropsTypes) => {
  ...
  const FormSchema = Yup.object().shape({
        ...
        lastName:Yup.string().required(`Last name number is required`),
        picture:Yup.string().required(`Picture number is required`),
          ...
          >
            ...
            >
              ...
              >
                ...
                {console.log(queryData.provider)}
                <Formik
                  initialValues={{
                    ...
                    picture: queryData?.provider.profile?.picture
                      ? queryData?.providprofile?.picture
                      : ``,
                    state: ``,
                    city: ``,
                    gender: ``,
