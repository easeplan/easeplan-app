...
const AvailableFunds = ({ token, bankDetails, queryData }: any) => {
  ...
  const handleValidationAcc = async (e: any) => {
    ...
    //           Authorization: `${process.env.NEXT_PUBLIC_DOJAH_AUTH_SECRET}`,
  ...
  return (
    ...
    >
      ...
      <Box>
        ...
        <Box sx={{}}>
          ...
          >
            ...
            >
              ...
              >
                10% Charge will be deducted for each payment
              </Typography>
            </Box>
          </Box>
        </Box>
        ...
        {/* ADD BANK SECTION*/}
        {!localQueryData?.provider?.providerProfile?.accountDetails ? (
          <>
            <Typography
              mb={2}
              mt={4}
