            ...
            >
              ...
              >
                ...
                <Box sx={{ borderTop: `solid 1px #ccc` }}>
                  ...
                  >
                    Save to grepper In this approach, you would need to know the
                    initial value of isRegistered when deciding the schema. If
                    the value changes during the form's life, you'll need to
                    reset the form or find another way to re-evaluate the
                    validation schema.
                    {(
