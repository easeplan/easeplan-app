...
By accessing, viewing the Platform or using the Services through any means, you accept our terms and conditions and agree to be bound.
1. INTRODUCTION
Easeplan Limited ("Easeplan") operates as a platform to link vendors, event planners and users
through its website: easplan.io (“Platform”).
Easeplan is the ultimate e-event marketplace connecting event planners and vendors like never before. As Africa's premier platform, Easeplan provides enabling infrastructure that empowers a diverse ecosystem of users. Whether you're an event planner seeking the perfect vendors to create unforgettable experiences or a vendor looking to showcase your services to a wider audience, Easeplan’s technology rails have got you covered.
