...
const InstagramOnboarding: React.FC<InstagramOnboardingProps> = ({
  ...
  const loadPhotos = async () => {
    const data = await fetchInstagramPhotos(
      `IGQWROR254WFNCdzFGdTlSbF9mTy03N2pFaFkteHk4ZAmxJVWhIRzVIWDZA1Qlo2ZAEtPWmhKd1F4TUo4X1JMUWlCVzBDbzhfYnFZAR05wc3RJaVVyd2tJZAm5oMUIyLUZAkWlZAnem1jd3MzQVZACZAG1JMndrYk1Rb19TT0YycjVvRm9RUmUzdwZDZD","user_id":23964241119890640`,
      `23964241119890640`,
    );
    setPhotos(data);
  };
