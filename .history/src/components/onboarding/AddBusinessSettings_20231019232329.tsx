...
const BusinessSettings = ({ token }: PropsTypes) => {
  ...
  const { stepFour, stepThree } = useSelector((state: RootState) => state.onboarding);
                ...
                >
                  {({ setFieldValue }) => (
                    <Form>
                      ...
                      </Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box></Box>
                      <Box>
                        <TextArea
                          name="description"
                          rows={4}
