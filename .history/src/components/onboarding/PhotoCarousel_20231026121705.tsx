...
const InstagramOnboarding: React.FC<InstagramOnboardingProps> = ({
  ...
  const loadPhotos = async () => {
    const data = await fetchInstagramPhotos(
      `IGQWRNX1p2YmpaU0NDQUlVT0ZAkOVlzWmtfUkdMeXo1Ry12YW5HU3J5T0xuNm40bHRzVUF4SVNOTDFYdkpTVklmV2VWUl9aaDNuVGdJZAktjc0VuZAFFGMHBZAQWYzdWIyOHo5di10bkp4SDcxek9xSHNJWVNYcm0wT1VESjVLMXFuWWdGZAwZDZD`,
      `23964241119890640`,
    );
    setPhotos(data);
  };
